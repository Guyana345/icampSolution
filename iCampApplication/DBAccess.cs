...
namespace iCampApplication
{
    class DBAccess
    {
        ...
        public void InsertParent1(string name, string email, string phone)
        {
            string query2 = "INSERT INTO camp_student_parent1(PARENT1_NAME, PARENT1_EMAIL, PARENT1_PHONE) VALUES('" + name + "','" + email + "', '" + phone + "')";
        ...
        public void InsertParent2(string name, string email, string phone)
        {
            string query2 = "INSERT INTO camp_student_parent2(PARENT2_NAME, PARENT2_EMAIL, PARENT2_PHONE) VALUES('" + name + "','" + email + "', '" + phone + "')";
